...
It features the ability to remove skyboxes / backgrounds from images, tools to automate the capture of many targets in sequence, post-processing effects, and bindings that let developers write their own capture workflows.
